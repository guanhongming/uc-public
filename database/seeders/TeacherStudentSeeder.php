...
class TeacherStudentSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $student1 = User::create(['name' => 'Alice', 'email' => 'student1@example.com', 'password' => Hash::make('password')]);
        $student2 = User::create(['name' => 'Bob', 'email' => 'bob@example.com', 'password' => Hash::make('password')]);
        $student3 = User::create(['name' => 'Charlie', 'email' => 'charlie@example.com', 'password' => Hash::make('password')]);
        ...
        $student4 = User::create(['name' => 'David', 'email' => 'david@example.com', 'password' => Hash::make('password')]);
        $student5 = User::create(['name' => 'Eve', 'email' => 'eve@example.com', 'password' => Hash::make('password')]);
